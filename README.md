...
1b - SALVO IL VALORE DI i IN UNA VARIABILE COSì DA POTERLA MODIFICARE
2 - CON L'OPERAZIONE % CONTROLLO SE è MULTIPLO DI 15 E STAMPO FIZZBUZZ
3 - CON L'OPERAZIONE % CONTROLLO SE è MULTIPLO DI 3 E STAMPO FIZZ
4 - CON L'OPERAZIONE % CONTROLLO SE è MULTIPLO DI 5 E STAMPO BUZZ